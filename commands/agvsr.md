---
description: Ensure the agvsr daemon is running, then hand off to the agvsr skill for submitting and managing jobs in this project.
---

Bootstrap `agvsr` for this project. This command only gets the daemon up —
once it reports ready, use the `agvsr` skill for submitting jobs, approvals,
...
too, as long as that project has its own `team.yaml`.
